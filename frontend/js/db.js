...
// const API_URL = "https://attendx-growthcraft360.onrender.com";
...
const DB = {
  ...
  async checkIn()           { const location = await this.getLocation(); return this.post("/attendance/checkin", { location }); },
  async checkOut(breakMins) { const location = await this.getLocation(); return this.post("/attendance/checkout", { breakMins, location }); },
  async lunchIn()           { const location = await this.getLocation(); return this.post("/attendance/lunch-in", { location }); },
  async lunchOut()          { const location = await this.getLocation(); return this.post("/attendance/lunch-out", { location }); },
  ...
  async viewDocument(userId, docType) { return this.get(`/documents/${userId}/${docType}/view`); },
