...
function showLateBanner(type) {
  ...
  banner.innerHTML = type === "half-day"
    ? `<i class="fa-solid fa-triangle-exclamation"></i> Half Day Marked — Aap 12:00 baje ke baad check-in kiye hain`
    : `<i class="fa-solid fa-clock"></i> Late Arrival — Aap 11:00 baje ke baad check-in kiye hain`;
...
async function doCheckIn() {
  ...
  try {
    ...
    if (res.isHalfDay) {
      ...
      showToast("✅ Checked in at " + res.checkIn, "success");
    }
    await renderDashboard();
  } catch (err) {
